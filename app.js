...
let scanHistory = [];
let scanLog = [];        // persisted full log of every successful lookup, for export
...
function openMappingScreen(rows) {
  ...
  [mapBarcode, mapStyle, mapPrice, mapDesc, mapSilver].forEach(sel => (sel.innerHTML = ""));
